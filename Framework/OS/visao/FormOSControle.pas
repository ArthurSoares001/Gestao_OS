...
begin
  if (stgDados.Row - 1 < 0) or (stgDados.Row - 1 >= ListaOS.Count) then
  begin
    // Limpar as grids de produtos e serviços se nenhuma linha válida for selecionada
  ...
  // Chamar o método Procurar para obter a OS completa com os itens
  ...
  try
    ...
    begin
      // Limpar as grids de produtos e serviços se a OS não for encontrada
      stgDadosProduto.RowCount := 2;
      stgDadosProduto.Rows[1].Clear;
      stgDadosServico.RowCount := 2;
      stgDadosServico.Rows[1].Clear;
