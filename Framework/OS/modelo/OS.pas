...
function TOS.getCliente: TOrObject;
begin
  Result := cliente;
end;

function TOS.getTecnicoResponsavel: TOrObject;
begin
...
function TOS.getStatus: TOrObject;
begin
  Result := status;
end;

function TOS.getPrioridade: TOrObject;
begin
  Result := prioridade;
end;
...
function TOS.getMotivoCancelamento: TOrObject;
begin
...
procedure TOS.setCliente(cliente: TOrObject);
begin
  self.cliente := cliente;
end;

procedure TOS.setTecnicoResponsavel(tecnicoResponsavel: TOrObject);
begin
...
procedure TOS.setStatus(status: TOrObject);
begin
  self.status := status;
end;

procedure TOS.setPrioridade(prioridade: TOrObject);
begin
...
procedure TOS.setMotivoCancelamento(motivoCancelamento: TOrObject);
begin
