...
uses Forms, StdCtrls, Mask, ExtCtrls, Grids, WinTypes, SysUtils, RxToolEdit, Menus,
     ...
     OrObject, RXSpin, Windows, Messages, Variants,
...
uses ShellAPI, HttpApp, CRC32, shlobj, IniFiles, Printers, Registry,
     ...
     IdText, IdAttachmentFile, IdComponent, OrMaskEdit,
     IdICMPClient, StrUtils, ComObj, OrDateEdit, OrCurrencyEdit,
     ACBrUtil, ACBrMail, pcnConversaoNFe, OrMemo,
     pcnConversao;
...
begin
   ...
   texto := StringReplace(texto, 'ˆ', '', [rfReplaceAll, rfIgnoreCase]);
   texto := StringReplace(texto, '«', '', [rfReplaceAll, rfIgnoreCase]);
   texto := StringReplace(texto, 'š', '', [rfReplaceAll, rfIgnoreCase]);
